...
Download or Clone this repo (git clone https://github.com/samy101/paddy-vlm.git). PaddyVLM folder contain two python notebook and datasets folder and other_resources
